                ...
                <CardContent>
                  ...
                  >
                    ...
                    <Box>
                      ...
                      >
                        {list.saved_list_ids.includes(list.list.id) ? (
                          <BookmarkIcon />
                        ) : (
                          <BookmarkBorderIcon />
                        )}
                  ...
                  {listAuthor && (
                    <Box sx={{ mb: 2 }}>
                      <Typography variant="body2" color="textSecondary">
                        Last activity:{" "}
                        {new Date(list.list.updated).toLocaleString()}
                      </Typography>
                      <Box
                      ...
                      >
                        ...
                        <Typography variant="subtitle1">
                          <Link
                            href={`/user_profile?id=${listAuthor.id}`}
                            underline="hover"
                            sx={{
                  ...
                  >
                    ...
                    >
                      ...
                      <Typography variant="subtitle1" display="inline">
                        {list && list.list ? list.list.score : 0}
                        {/* Display total score */}
                      </Typography>
                      <IconButton
                        color={"primary"}
                    ...
                    <Stack direction={"row"} gap={"2px"}>
                      ...
                      {listAuthor &&
                        listAuthor.id == getUserIdFromAccessToken() && (
                          <>
                            <IconButton
                              aria-label="more"
