...
export const DBSetup = () => {
  ...
  const fetchUserData = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/users_db_setup/`);
  ...
  const fetchListData = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/lists_db_setup/`);
      const data = await response.json();
      return data.results;
    } catch (error) {
  ...
  const fetchRankData = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/rank_home/`);
      const data = await response.json();
      return data.ranks;
    } catch (error) {
  ...
  const postNewUserData = async () => {
    try {
      ...
      await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/users_db_setup/`, {
        method: "POST",
  ...
  const postNewListData = async () => {
    try {
      ...
      await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/lists_db_setup/`, {
        method: "POST",
  ...
  const postNewRankData = async () => {
    try {
      ...
      await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/ranks_db_setup/`, {
        method: "POST",
